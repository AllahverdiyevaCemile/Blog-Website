...
<div id="content-wrapper">
    <div class="container-fluid">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
               ...
               if(isset($_POST["add_category"])){
                    ...
                    if($category_name == "" || empty($category_name)){
                        ...
                        header("Localhost: categories.php");
                }
                ...
                if (isset($_POST['edit_category'])){
                    $edit_cat = $_POST['category_namex'];
                    $sql_query2 = "UPDATE categories SET category_name='$edit_cat' WHERE category_id = '$_POST[category_id]'";
                    $edit_cat_query = mysqli_query($conn,$sql_query2);
            ...
            $sql_all_categories = mysqli_query($conn,$sql_query);
            $k=1;
            while($row=mysqli_fetch_assoc($sql_all_categories)){
