...
<div id="wrapper">
    ...
    <div id="content-wrapper">
                        ...
                        echo "<td>
                            <div class='dropdown'>
                                ...
                                <div class='dropdown-menu' aria-labelledby='dropdownMenuButton'>
                                    ...
                                    <div class='dropdown-divider'></div>
                                    <a class='dropdown-item' href='comment.php?approved={$comment_id }'>Approve</a>
                                    <div class='dropdown-divider'></div>
                                    <a class='dropdown-item' href='comment.php?unapproved={$comment_id }'>Unapprove</a>
                                </div>
                            </div>
                        </td>
                    </tr>";
                                ...
                                <div class="modal-body">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input readonly type="text" class="form-control" name="comment_email" value="<?php echo $comment_email; ?>">
                                        </div>
                                        <div class="form-group">
		...
		if(isset($_GET["approved"])){
			...
			$approved_comment_query = mysqli_query($conn, $sql_query);
        ...
        if(isset($_GET["unapproved"])){
			...
			$unapproved_comment_query = mysqli_query($conn, $sql_query);
			header("Location: comment.php");
		}
