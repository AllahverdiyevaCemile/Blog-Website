...
<div id="content-wrapper">
    <div class="container-fluid">
		...
		if(isset($_POST["add_portfolio"])){
				...
				$query = "INSERT INTO portfolio (portfolio_name, portfolio_category, portfolio_img_sm, portfolio_img_bg)";
		...
		$portfolio_img_sm_temp = $_FILES["imagebg"]["tmp_name"];

                      if(empty($portfolio_img_sm)) {
                        $query2 = "SELECT * FROM portfolio WHERE portfolio_id = '$_POST[portfolio_id]'";
                    ...
                    if(empty($portfolio_img_bg)){
                        $query3 = "SELECT * FROM portfolio WHERE portfolio_id = '$_POST[portfolio_id]'";
		...
		$sql_query2 = "UPDATE portfolio SET portfolio_name = '{$portfolio_name}', portfolio_category = '{$portfolio_category}', portfolio_img_sm = '{$portfolio_img_sm}', portfolio_img_bg = '{$portfolio_img_bg}' WHERE portfolio_id = '$_POST[portfolio_id]'";
		...
		<?php
			$sql_query = "SELECT * FROM portfolio ORDER BY portfolio_id DESC";
			...
			<tr>
                    ...
                    <td><img src='../img/{$portfolio_img_sm}' with= '80px' height= '80px'></td>
                    <td><img src='../img/{$portfolio_img_bg}' with= '80px' height= '80px'></td>
                    <td>
                        <div class='dropdown'>
