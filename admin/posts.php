        ...
        <div class="container-fluid">
            ...
            <table class="table table-bordered ">
                ...
                if(isset($_POST["add_post"])){
                        ...
                        $query = "INSERT INTO posts (post_title, post_category, post_author, post_text, post_date, post_tags, post_comment_number, post_image)";

                        
                        $query .= "VALUES('{$post_title}', '{$post_category}', '{$post_author}', '{$post_text}', '{$post_date}', '{$post_tags}', '{$post_comment_number}', '{$post_image}')";
               ...
               <?php 
                if(isset($_POST["edit_post"])) {
                    ...
                    $sql_query2 = "UPDATE posts SET post_title = '$post_title', post_category = '$post_category', post_author = '$post_author', post_tags= '$post_tags', post_text= '$post_text', post_image = '$post_image' WHERE post_id = '$_POST[post_id]'";
                    
                    $edir_post_query = mysqli_query($conn, $sql_query2);
                    header("Location: posts.php");
                }
                ?>
                    <?php
                                ...
                                <div class="modal-body">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="post_text" id="" cols="20" rows="5" value="<?php echo $post_text; ?>"></textarea>
                                        </div>
