			...
			<div class="row">
				<main id="main" class="col-md-8">
					<div class="row">
						...
						$look_all_posts = mysqli_query($conn, $sql_query2);
						$all_post_count = mysqli_num_rows($look_all_posts);
						 $page_number = ceil ($all_post_count / 4);
                            ...
                            while($row=mysqli_fetch_assoc($select_all_posts)){
								...
								<div class="blog">
									<div class="blog-img">
										<img  src="img/<?php echo $post_image; ?>" class="img-fluid" style="width:350px; height:300px" >
									</div>
									<div class="blog-content">
										<ul class="blog-meta">
											...
											<li><i class="fas fa-comments"></i><span class="writer"><?php echo $post_hits; ?></span></li>
										</ul>
